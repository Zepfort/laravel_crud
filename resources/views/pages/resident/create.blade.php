                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                @error('nik') is-invalid @enderror" required value="{{ old('nik')}}">
                                @error('nik')
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col">
                                ...
                                @error('birth_place') is-invalid @enderror" required value="{{ old('birth_place')}}">
                                @error('birth_place')
                                    <span class="invalid-feedback">
                                        {{ $message}}
                                    </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" inputmode="text" name="religion" id="religion" class="form-control" value="{{ old('religion')}}">
                            @error('religion')
                                    <span class="invalid-feedback">
                                        {{ $message}}
                                    </span>
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col">
                                ...
                                @error('phone') is-invalid @enderror required value="{{ old('phone')}}">
                                @error('phone')
                                    <span class="invalid-feedback">
                                        {{ $message}}
                                    </span>
